...
class TestSmartRouterPersona:
    ...
    def test_romantic_persona_with_image_request(self, mock_user_with_local):
        ...
        decision = router.route(message="kedi resmi çiz", user=mock_user_with_local, persona_name="romantic")
    ...
    def test_romantic_persona_with_web_request(self, mock_user_with_local):
        ...
        decision = router.route(message="hava bugün nasıl", user=mock_user_with_local, persona_name="romantic")
    ...
    def test_romantic_persona_with_chat(self, mock_user_with_local):
        ...
        decision = router.route(message="selam", user=mock_user_with_local, persona_name="romantic")
    ...
    def test_tool_priority_over_persona(self, mock_user_with_local):
        ...
        decision = router.route(
            message="bir kedi çiz bana", user=mock_user_with_local, persona_name="romantic"  # requires_uncensored
        )
