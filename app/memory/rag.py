    ...
    try:
        ...
        try:
            ...
            try:
                ...
                pass
            collection = client.create_collection(  # type: ignore
                name="rag_docs",
        ...
        if results and results.get("ids"):
            ...
            if ids_list and metadatas_list and documents_list:
                for i, doc_id in enumerate(ids_list[0]):
                    ...
                    doc_owner: Optional[str] = str(owner_val) if owner_val and isinstance(owner_val, (str, int, float)) else None
