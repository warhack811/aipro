...
class ModelConfig(SQLModel, table=True):
    ...
    __table_args__ = (UniqueConstraint("name", name="uq_model_config_name"),)
...
class APIConfig(SQLModel, table=True):
    ...
    __table_args__ = (UniqueConstraint("name", name="uq_api_config_name"),)
...
class ThemeConfig(SQLModel, table=True):
    ...
    __table_args__ = (UniqueConstraint("name", name="uq_theme_config_name"),)
...
class PersonaConfig(SQLModel, table=True):
    ...
    __table_args__ = (UniqueConstraint("name", name="uq_persona_config_name"),)
    ...
    # Model Kısıtlamaları
    allowed_providers: List[str] = Field(default=["groq", "ollama"], sa_column=Column(JSON))
    ...
    example_dialogues: List[Dict[str, str]] = Field(default=[], sa_column=Column(JSON))
...
class ImageGenConfig(SQLModel, table=True):
    ...
    __table_args__ = (UniqueConstraint("name", name="uq_image_gen_config_name"),)
    ...
    negative_prompt_template: str = Field(default="low quality, blurry, distorted", sa_column=Column(Text))
