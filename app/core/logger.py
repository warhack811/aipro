...
def log_request(
    logger: logging.Logger, method: str, path: str, user: Optional[str] = None, extra: Optional[dict] = None
) -> None:
    """
...
def log_response(logger: logging.Logger, status_code: int, duration_ms: float, extra: Optional[dict] = None) -> None:
    """
